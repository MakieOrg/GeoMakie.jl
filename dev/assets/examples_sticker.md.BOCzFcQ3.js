import{_ as s,o as a,c as p,aA as e}from"./chunks/framework.cUX9zsid.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"examples/sticker.md","filePath":"examples/sticker.md","lastUpdated":null}'),l={name:"examples/sticker.md"};function i(t,n,o,r,c,d){return a(),p("div",null,[...n[0]||(n[0]=[e(`<p>We make a sticker by finding the cropping polygon of the interrupted Goode homolosine.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> GeoMakie, CairoMakie</span></span>
